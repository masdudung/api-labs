...
class Trans extends CI_Controller 
{
	...
	{	
        ...
        $tanggal = $this->input->get('date', true);
        if($token==null || $tanggal==null)
        {
        ...
        $result['error'] = false;
		$result['message'] = $this->ApiModel->get_trans_by_tgl($tanggal);
		echo json_encode($result);
    }
    
    public function lala()
    {
        echo base64_encode("1829174060561133:EAAaogEPvNnYBANtIWUtHUE8P");
    }
}
